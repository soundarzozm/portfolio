...
const Footer: NextComponentType = () => {
	return (
		<footer className="flex justify-center items-center space-x-8 w-fit">
			<Image
			...
			/>
			<div
				className="flex justify-center items-center mx-4 space-x-4 text-sm hover:cursor-pointer"
				onClick={() => {
					window
						.open('http://www.twitter.com/soundarzozm', '_blank')!
						.focus()
				}}
			>
				<svg
			...
			<div
				...
				onClick={() => {
					window
						.open('http://www.github.com/soundarzozm', '_blank')!
						.focus()
				}}
			>
				<svg
